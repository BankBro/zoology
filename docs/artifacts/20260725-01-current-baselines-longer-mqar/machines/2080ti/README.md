# 20260725-01 当前基线 Longer-MQAR: 2080ti
...
本目录只包含 `2080ti` 的机器级结果. 完整解释见 `docs/20260725-01-current-baselines-longer-mqar-report.md`. Raw输出保留在 `/home/lyj/mnt/project/zoology/zoology/experiments/flash_vqg/scripts/20260725-01-current-baselines-longer-mqar/outputs`. 本轮使用专用 collector直接生成统计, 未另跑 analysis suite, 因而没有 `zoology/analysis/flash_vqg/results/<launch_id>/` 目录.
