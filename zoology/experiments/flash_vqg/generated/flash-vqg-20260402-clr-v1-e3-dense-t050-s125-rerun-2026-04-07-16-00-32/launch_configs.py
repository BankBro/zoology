# -*- coding: utf-8 -*-
# 此文件由临时 rerun 脚本自动生成.
# 目标: 复用 e3 dense-t050 配置, 从头重跑 seed125, 单 GPU 顺序执行.
...
def _build_dense_t050_for_seed(seed: int, run_id: str):
    ...
    base.update({
        ...
        "launch_id_prefix": "flash-vqg-20260402-clr-v1-e3-dense-t050-s125-rerun",
    })
...
configs = [
    _build_dense_t050_for_seed(125, "dense-t050-s125-rerun"),
]
