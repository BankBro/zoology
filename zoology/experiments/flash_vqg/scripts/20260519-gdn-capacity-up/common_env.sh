...
PROJECT="${PROJECT:-flash_vqg_gdn_capacity_up}"
...
EXPERIMENT_MODE_OVERRIDE="${EXPERIMENT_MODE_OVERRIDE:-gdn_capacity_up}"

LAUNCH_ID_PREFIX="${LAUNCH_ID_PREFIX:-flash-vqg-20260519-gdn-capacity-up}"
