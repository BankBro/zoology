...
def _base_args(
    *,
    ...
    if target not in {"no-embed-dropout-s123-r1", "no-embed-dropout-s123-r2"}:
    ...
    return Namespace(
        ...
        project="flash_vqg_stability_ablation",
        entity="scu-mclab",
...
def build_parser() -> argparse.ArgumentParser:
    ...
    p.add_argument("--target", choices=["no-embed-dropout-s123-r1", "no-embed-dropout-s123-r2"], default="no-embed-dropout-s123-r1")
    p.add_argument("--variant", choices=["no-embed-dropout"], default="no-embed-dropout")
    ...
    p.add_argument("--machine-name", required=True)
    p.add_argument("--target", choices=["no-embed-dropout-s123-r1", "no-embed-dropout-s123-r2"], required=True)
    p.add_argument("--variant", choices=["no-embed-dropout"], default="no-embed-dropout")
