...
LAUNCH_ID_PREFIX_E3="${LAUNCH_ID_PREFIX_E3:-flash-vqg-20260402-clr-v1-e3}"
...
BUILDER_SPEC="${SCRIPT_DIR}/config_builder.py:build_e3_train_configs"
"${PYTHON_BIN}" -m zoology.experiments.flash_vqg.run_flash_vqg_suite \
  ...
  --project "${PROJECT}" \
  --entity "${ENTITY}" \
  --launch-id-prefix "${LAUNCH_ID_PREFIX_E3}" \
