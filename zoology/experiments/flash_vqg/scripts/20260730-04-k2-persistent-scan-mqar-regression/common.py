...
EXPECTED_FLASH_COMMIT = "a6b1af3d8845caa7f317e7104a1af500a03b1c24"
...
SEEDS = (123, 124, 125)
VARIANTS = {
    "p0-a1-block64": "post_phase1",
    "k2-persistent-p8": "post_phase1",
}
BUILDERS = {
    "p0-a1-block64": "grouped_chunk_torch_ref",
    "k2-persistent-p8": "persistent_scan_triton",
}
...
def run_tag() -> str:
    value = os.environ.get("MQAR_K2_PERSISTENT_RUN_TAG", "").strip()
    if not re.fullmatch(r"[A-Za-z0-9_.-]+", value):
        raise RuntimeError("MQAR_K2_PERSISTENT_RUN_TAG must be a non-empty safe name.")
    return value
