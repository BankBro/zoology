...
EXPECTED_FLASH_COMMIT = "a18b32960b41170b5a546588b3b2ebbd0f0578b7"
...
LONGER_CASES = (
    ...
    (8190, 512, 4, "37a8533a985fabd3db03daf9dfd3a8e0936513ab724039c63b9a22bf352d002d"),
    (8190, 2047, 4, "8c16a91ea127bb7bf2130238ecd56b49fb1fd73bb3e0c2f4c586ddba8e9b97a9"),
)


def run_tag() -> str:
    value = os.environ.get("MQAR_BLOCK64_REMAT_RUN_TAG", "").strip()
    if not re.fullmatch(r"[A-Za-z0-9_.-]+", value):
        raise RuntimeError("MQAR_BLOCK64_REMAT_RUN_TAG must be a non-empty safe name.")
    return value
