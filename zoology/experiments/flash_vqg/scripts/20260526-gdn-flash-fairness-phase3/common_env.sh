...
PROJECT="${PROJECT:-flash_vqg_gdn_flash_fairness_phase3}"
...
EXPERIMENT_MODE_OVERRIDE="${EXPERIMENT_MODE_OVERRIDE:-gdn_flash_fairness_phase3_banked_k}"
LAUNCH_ID_PREFIX="${LAUNCH_ID_PREFIX:-flash-vqg-20260526-gdn-flash-fairness-phase3}"
