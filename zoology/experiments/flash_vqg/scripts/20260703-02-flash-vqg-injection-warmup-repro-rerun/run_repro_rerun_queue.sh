...
if [[ "$#" -lt 1 ]]; then
  cat >&2 <<'USAGE'
Usage:
  run_repro_rerun_queue.sh <queue-name>

Queues:
  reprowarm-2080ti-gpu0-linear512
  reprowarm-2080ti-gpu1-silent64linear512
  reprowarm-3090-gpu0-all
  reprowarm-3090-gpu0-linear512
  reprowarm-3090-gpu0-silent64linear512
USAGE
  exit 2
fi
...
case "${QUEUE_NAME}" in
  ...
  reprowarm-3090-gpu0-all)
    ...
    GPU="0"
    TARGETS=("inj-warmup-linear512-r2" "inj-warmup-silent64-linear512-r2")
    ;;
  reprowarm-3090-gpu0-linear512)
    MACHINE_NAME="${MACHINE_NAME:-3090}"
    GPU="0"
