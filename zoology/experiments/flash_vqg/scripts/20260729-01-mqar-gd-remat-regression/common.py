...
EXPECTED_FLASH_COMMIT = "79fef6a8e9d3f41dfcbf40bf668ec83286dd5d62"
...
def run_tag() -> str:
    value = os.environ.get("MQAR_GD_REMAT_RUN_TAG", "").strip()
    if not re.fullmatch(r"[A-Za-z0-9_.-]+", value):
        raise RuntimeError("MQAR_GD_REMAT_RUN_TAG must be a non-empty safe name.")
    return value
