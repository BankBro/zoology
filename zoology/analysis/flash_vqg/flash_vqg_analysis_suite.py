    ...
    row.update(
        {
            ...
            "fox_gd_residual_grouped_chunk_backend": config_summary.get("fox_gd_residual_grouped_chunk_backend", flash_kwargs.get("fox_gd_residual_grouped_chunk_backend")),
            "fox_gd_residual_selected_read_backend": config_summary.get("fox_gd_residual_selected_read_backend", flash_kwargs.get("fox_gd_residual_selected_read_backend")),
            "fox_gd_residual_selected_read_chunk_size": config_summary.get("fox_gd_residual_selected_read_chunk_size", flash_kwargs.get("fox_gd_residual_selected_read_chunk_size")),
            ...
            "fox_gd_residual_beta_init": config_summary.get("fox_gd_residual_beta_init", flash_kwargs.get("fox_gd_residual_beta_init")),
            "fox_gd_residual_beta_cap": config_summary.get("fox_gd_residual_beta_cap", flash_kwargs.get("fox_gd_residual_beta_cap")),
            "fox_gd_residual_beta_cap_final": config_summary.get("fox_gd_residual_beta_cap_final", flash_kwargs.get("fox_gd_residual_beta_cap_final")),
            "fox_gd_residual_beta_cap_release_start_train_steps": config_summary.get("fox_gd_residual_beta_cap_release_start_train_steps", flash_kwargs.get("fox_gd_residual_beta_cap_release_start_train_steps")),
            "fox_gd_residual_beta_cap_release_end_train_steps": config_summary.get("fox_gd_residual_beta_cap_release_end_train_steps", flash_kwargs.get("fox_gd_residual_beta_cap_release_end_train_steps")),
            "fox_gd_residual_beta_cap_eval_policy": config_summary.get("fox_gd_residual_beta_cap_eval_policy", flash_kwargs.get("fox_gd_residual_beta_cap_eval_policy")),
            "fox_gd_residual_beta_control_mode": config_summary.get("fox_gd_residual_beta_control_mode", flash_kwargs.get("fox_gd_residual_beta_control_mode")),
            "fox_gd_residual_beta_sigmoid_temp": config_summary.get("fox_gd_residual_beta_sigmoid_temp", flash_kwargs.get("fox_gd_residual_beta_sigmoid_temp")),
            "fox_gd_residual_beta_low": config_summary.get("fox_gd_residual_beta_low", flash_kwargs.get("fox_gd_residual_beta_low")),
            "fox_gd_residual_beta_high": config_summary.get("fox_gd_residual_beta_high", flash_kwargs.get("fox_gd_residual_beta_high")),
            "fox_gd_residual_beta_low_final": config_summary.get("fox_gd_residual_beta_low_final", flash_kwargs.get("fox_gd_residual_beta_low_final")),
            "fox_gd_residual_beta_high_final": config_summary.get("fox_gd_residual_beta_high_final", flash_kwargs.get("fox_gd_residual_beta_high_final")),
            "fox_gd_residual_beta_band_release_start_train_steps": config_summary.get("fox_gd_residual_beta_band_release_start_train_steps", flash_kwargs.get("fox_gd_residual_beta_band_release_start_train_steps")),
            "fox_gd_residual_beta_band_release_end_train_steps": config_summary.get("fox_gd_residual_beta_band_release_end_train_steps", flash_kwargs.get("fox_gd_residual_beta_band_release_end_train_steps")),
            "fox_gd_residual_beta_band_eval_policy": config_summary.get("fox_gd_residual_beta_band_eval_policy", flash_kwargs.get("fox_gd_residual_beta_band_eval_policy")),
            "fox_gd_residual_beta_band_schedule": config_summary.get("fox_gd_residual_beta_band_schedule", flash_kwargs.get("fox_gd_residual_beta_band_schedule")),
            "fox_gd_residual_lambda_init": config_summary.get("fox_gd_residual_lambda_init", flash_kwargs.get("fox_gd_residual_lambda_init")),
            "fox_gd_residual_lambda_floor": config_summary.get("fox_gd_residual_lambda_floor", flash_kwargs.get("fox_gd_residual_lambda_floor")),
            "fox_gd_residual_write_strength_cap": config_summary.get("fox_gd_residual_write_strength_cap", flash_kwargs.get("fox_gd_residual_write_strength_cap")),
            "fox_gd_residual_write_strength_cap_final": config_summary.get("fox_gd_residual_write_strength_cap_final", flash_kwargs.get("fox_gd_residual_write_strength_cap_final")),
            "fox_gd_residual_write_budget": config_summary.get("fox_gd_residual_write_budget", flash_kwargs.get("fox_gd_residual_write_budget")),
            "fox_gd_residual_write_budget_final": config_summary.get("fox_gd_residual_write_budget_final", flash_kwargs.get("fox_gd_residual_write_budget_final")),
            "fox_gd_residual_write_budget_release_start_train_steps": config_summary.get("fox_gd_residual_write_budget_release_start_train_steps", flash_kwargs.get("fox_gd_residual_write_budget_release_start_train_steps")),
            "fox_gd_residual_write_budget_release_end_train_steps": config_summary.get("fox_gd_residual_write_budget_release_end_train_steps", flash_kwargs.get("fox_gd_residual_write_budget_release_end_train_steps")),
            "fox_gd_residual_write_budget_eval_policy": config_summary.get("fox_gd_residual_write_budget_eval_policy", flash_kwargs.get("fox_gd_residual_write_budget_eval_policy")),
            "fox_gd_residual_write_budget_schedule": config_summary.get("fox_gd_residual_write_budget_schedule", flash_kwargs.get("fox_gd_residual_write_budget_schedule")),
            "fox_gd_residual_write_total_cap": config_summary.get("fox_gd_residual_write_total_cap", flash_kwargs.get("fox_gd_residual_write_total_cap")),
            "fox_gd_residual_write_total_cap_final": config_summary.get("fox_gd_residual_write_total_cap_final", flash_kwargs.get("fox_gd_residual_write_total_cap_final")),
            "fox_gd_residual_write_total_cap_release_start_train_steps": config_summary.get("fox_gd_residual_write_total_cap_release_start_train_steps", flash_kwargs.get("fox_gd_residual_write_total_cap_release_start_train_steps")),
            "fox_gd_residual_write_total_cap_release_end_train_steps": config_summary.get("fox_gd_residual_write_total_cap_release_end_train_steps", flash_kwargs.get("fox_gd_residual_write_total_cap_release_end_train_steps")),
            "fox_gd_residual_write_total_cap_eval_policy": config_summary.get("fox_gd_residual_write_total_cap_eval_policy", flash_kwargs.get("fox_gd_residual_write_total_cap_eval_policy")),
            "fox_gd_residual_write_total_cap_schedule": config_summary.get("fox_gd_residual_write_total_cap_schedule", flash_kwargs.get("fox_gd_residual_write_total_cap_schedule")),
            "fox_gd_residual_write_q_alpha": config_summary.get("fox_gd_residual_write_q_alpha", flash_kwargs.get("fox_gd_residual_write_q_alpha")),
            "fox_gd_residual_update_norm_cap": config_summary.get("fox_gd_residual_update_norm_cap", flash_kwargs.get("fox_gd_residual_update_norm_cap")),
        }
    )
    return row
